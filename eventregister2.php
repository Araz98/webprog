...
if(isset ($user))
{
	...
	$sql="SELECT COUNT(*) from findtheheroinyou";
    ...
    if ($rows['COUNT(*)'] < 5) 
    {
    	...
    	$query = "SELECT * FROM findtheheroinyou WHERE username ='$user'";
...

		{
 		...
 		else
 		{
 			...
 			$sql1="INSERT INTO findtheheroinyou SELECT username,ic,email,gender,bloodtype FROM userprofile WHERE username='$user'";
