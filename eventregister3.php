...
if(isset ($user))
{
	...
	$sql="SELECT COUNT(*) from giveagiftoflife";
    ...
    if ($rows['COUNT(*)'] < 5) 
    {
    	...
    	$query = "SELECT * FROM giveagiftoflife WHERE username ='$user'";
...

		{
 		...
 		else
 		{
 			...
 			$sql1="INSERT INTO giveagiftoflife SELECT username,ic,email,gender,bloodtype FROM userprofile WHERE username='$user'";
